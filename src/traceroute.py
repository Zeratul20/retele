...
raspuns = requests.get(
    'https://ipinfo.io/widget/193.226.51.6', headers=fake_HTTP_header)
print("Raspuns: " + raspuns.text)
# ip_nostru = raspuns.json()['ip']

ip_nostru = raspuns.json()['ip']


# # pentru un IP rezervat retelei locale da bogon=True
# raspuns = requests.get('https://ipinfo.io/255.255.255.255', headers=fake_HTTP_header)
# print (raspuns)

traceroute(ip_nostru, 10000)
